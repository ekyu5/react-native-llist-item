...
import MainItemContainer from '../component/MainItemContainer';
 ...
 *  
 */
export default class TossMain extends React.Component<any, any> {
  render() {
    return (
          ...
          style={styles.container}>
                  ...
                  right={
                    <TouchableOpacity
                        ...
                        onPress={() => {
                          ...
                          this.props.navigation.navigate(PageName.CarrotUserMain);
                        }}
                    >
            ...
            <MainItemContainer>
              <AccountBalanceItem
                ...
                right={
                  <TouchableOpacity
                      style={styles.buttonConsume}
                      onPress={() => {console.log('onclick : ' + consumeData[0].title);}}>
                    <Text style={styles.buttonConsumeText}>새 내역 1건</Text>
                  </TouchableOpacity>
                }
                onPress={() => {
                  this.props.navigation.navigate(PageName.TossMonthlyRevenue);
                }}
              />
              <View style={styles.horizontalLine} />
              <AccountBalanceItem
